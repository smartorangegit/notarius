...
LEFT JOIN notary ON (deal.notaryID=notary.id) WHERE transactionStatus=2');
...
echo "<h3 class='section-heading'>Таблица обработаных заявок</h3>";
...
echo "<tr class='row100'>";
    ...
    echo "<a class='cell__link' href='/admin/dashboard/processed/".$item['deID']."'>";
    ...
    if(!empty($item['notarfName'])) {
        ...
        echo "<a class='cell__link' href='/admin/dashboard/processed/".$item['deID']."'><div style='width: 1px; height:20px'></div></a>";
        echo "</td>";
    }
